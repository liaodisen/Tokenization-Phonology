...
def main():
    ...
    if args.combine_datasets:
        if args.control_task_label:
            save_path = f'results/probing_results_g2p_{args.LLM}_{args.prefix}_combined_control_task_label.json'
        elif args.control_task_embed:
            save_path = f'results/probing_results_g2p_{args.LLM}_{args.prefix}_combined_control_task_embed.json'
        else:
            save_path = f'results/probing_results_g2p_{args.LLM}_{args.prefix}_combined.json'
    else:
        if args.control_task_label:
