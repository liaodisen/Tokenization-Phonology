...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="/model-weights/Meta-Llama-3.1-8B-Instruct")
...
def train():
    ...
    if data_args.data_path_conversation is not None:
    ...
    trainer.save_model(f"model_no_conversation/{model_name}")
